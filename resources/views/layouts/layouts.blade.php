                ...
                <div class="container text-center text-md-start mt-5">
                    ...
                    <div class="row mt-3">
                        ...
                        <div class="col-md-2 col-lg-2 col-xl-2 mx-auto mb-4">
                            ...
                            <p>
                                <a href="/foto" class="text-reset">Gallery</a>
                            </p>
                            <p>
                        ...
                        <div class="col-md-3 col-lg-2 col-xl-2 mx-auto mb-4">
                            ...
                            <p>
                                <a href="#kementerian" class="text-reset">Kabinet</a>
                            </p>
                            <p>
                                <a href="https://linktr.ee/bemkmudinus" class="text-reset">Kontak</a>
                            </p>
                            <p>
                                <a href="https://dinus.ac.id/" class="text-reset">Universitas Dian Nuswantoro</a>
                            </p>
                        ...
                        <div class="col-md-4 col-lg-3 col-xl-3 mx-auto mb-md-0 mb-4">
                            ...
                            <p><i class="fas fa-home me-3"></i>Gedung F UDINUS</p>
                            <p>
                                <i class="fas fa-envelope me-3"></i>bemkm@orma.dinus.ac.id
                            </p>
